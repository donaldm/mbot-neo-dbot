...
@pytest.mark.goodbye_commands
@pytest.mark.parametrize('phrase', ['see you', 'goodbye', 'good bye', 'goodnight', 'goodnight dbot', 'goodbye dbot'])
def test_goodbye(dbot_intent_parser_fixture, phrase):
